...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("username").Set "cnavarro" @@ script infofile_;_ZIP::ssf2.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Password").Click @@ script infofile_;_ZIP::ssf3.xml_;_
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("password").SetSecure "66194783db4c741d9c3860258dc8df0250216c92683f" @@ script infofile_;_ZIP::ssf4.xml_;_
